//Andrew Karpman
//MultiThread Part3
//Program counts the parallel time with 8 processores then computes the sequential Time
package Part3;
...
public class part3 {
 public static void main(String[] args) {
  ...
  MergeSort.parallelMergeSort(list2); // MergeSort is in Listing 24.5
 ...
 private static class SortTask<E extends Comparable<E>> extends RecursiveAction {//seems to allow 2 extends
 ...
 static class MergeSort  {//uses merge sort to organize the numbers
